...
root.resizable(0,0)
root.title("Website Blocker python project")

Label(root, text ='WEBSITE BLOCKER' , font ='arial 20 bold').pack()
Label(root, text ='GROUP 3' , font ='arial 20 bold').pack(side=BOTTOM)
...
def Blocker():
    website_lists = Websites.get(1.0,END) #capture start from end 
